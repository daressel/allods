> 📘 Если приходишь с фронтенда (React/HTML/CSS) и плохо представляешь как работают Widget-ы, открой [Widgets.md](Widgets.md) — там отдельное введение с аналогиями и примерами.
